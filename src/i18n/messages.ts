...
const authUz = {
  ...
  'validation.phoneInvalid': 'Telefon raqam + bilan boshlansin (masalan: +998901234567)',
...
const ru: Record<MessageKey, string> = {
  ...
  'validation.phoneInvalid': 'Номер должен начинаться с + (например: +998901234567)',
...
const en: Record<MessageKey, string> = {
  ...
  'validation.phoneInvalid': 'Phone must start with + (e.g. +998901234567)',
